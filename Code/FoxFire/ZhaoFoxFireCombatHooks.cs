...
public sealed class ZhaoFoxFireCombatHooks : AbstractModel
{
				...
				if (cardPlay.IsFirstInSeries && cardPlay.Card is ZhaoCardModel { FoxFireCost: >0 } zhaoCardModel)
				{
					...
					if (owner != null)
					{
						...
						if (!val.IsCompleted)
						{
							...
							_003C_003Eu__1 = val;
							_003C_003Et__builder.AwaitUnsafeOnCompleted<TaskAwaiter, _003CBeforeCardPlayed_003Ed__2>(ref val, ref this);
							return;
						}
						goto IL_009a;
					}
	...
	public override global::System.Threading.Tasks.Task BeforeCardPlayed(CardPlay cardPlay)
	{
		...
		_003CBeforeCardPlayed_003Ed__3._003C_003Et__builder.Start<_003CBeforeCardPlayed_003Ed__2>(ref _003CBeforeCardPlayed_003Ed__3);
		return _003CBeforeCardPlayed_003Ed__3._003C_003Et__builder.Task;
	}
}
